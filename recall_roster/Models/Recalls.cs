...
public class Recall
{
    ...
    public bool HasRecipientSnapshot { get; set; }
    [NotMapped] public int active => DateTime.UtcNow >= timeStarted && DateTime.UtcNow < timeEnded ? 1 : 0;
    [JsonIgnore] public ICollection<RecallRecipient> Recipients { get; set; } = new List<RecallRecipient>();
}
